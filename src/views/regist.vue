                    ...
                    <el-card class="box-card">
                        <div slot="header" class="clearfix">
                            <el-row>
                                <el-col :span="6" :offset="4">
                                    <el-button v-model="role" @click="role0" v-bind:class="{choose:isActive0}">我是求职者
                                    </el-button>
                                </el-col>
                                <el-col :span="6" :offset="4">
                                    <el-button v-model="role" @click="role1" v-bind:class="{choose:isActive1}">我是招聘者
                                    </el-button>
                                </el-col>
                            </el-row>
                        </div>
                        <div>
                            <div>
                                <el-row>
                                    <el-col :span="20" :offset="2">
                                        <el-input placeholder="请输入手机号" v-model="phone" class="regist-length"
                            ...
                            <div style="margin-top:30px">
                                <el-row>
                                    <el-col :span="20" :offset="2">
                                        <el-input placeholder="请输入邮箱" v-model="email" prefix-icon="el-icon-message"
                            ...
                            <div style="margin-top:30px">
                                <el-row>
                                    <el-col :span="20" :offset="2">
                                        <el-input placeholder="请输入6-18位数字和字母的密码" v-model="password" show-password
                                                  class="regist-length"></el-input>
                                    </el-col>
                                </el-row>
                            </div>
