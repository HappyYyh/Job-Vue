							...
							<div slot="header" class="clearfix">
								<el-row>
									<el-col :span="6" :offset="4">
										<el-button v-model="loginType" @click="type0" v-bind:class="{choose:isActive0}">密码登陆</el-button>
									</el-col>
									<el-col :span="6" :offset="4">
										<el-button v-model="loginType" @click="type1" v-bind:class="{choose:isActive1}">短信登陆</el-button>
									</el-col>
								</el-row>
							</div>
						<div>
							<div style="margin-top:30px" v-show="showPhoneAndEmail">
								<el-row>
									<el-col :span="20" :offset="2">
										<el-input placeholder="请输入手机号/邮箱" v-model="phoneAndEmail" class="regist-length"  prefix-icon="el-icon-mobile-phone"></el-input>
									</el-col>
								</el-row>
							</div>
							<div style="margin-top:30px" v-show="showPhone">
								<el-row>
									<el-col :span="20" :offset="2">
										<el-input placeholder="请输入手机号" v-model="phone" prefix-icon="el-icon-mobile-phone"  class="regist-length"></el-input>
									</el-col>
								</el-row>
							</div>
							...
							<div style="margin-top:30px" v-show="showPassword">
								<el-row>
									<el-col :span="20" :offset="2">
										<el-input placeholder="请输入密码" v-model="password" show-password class="regist-length"></el-input>
									</el-col>
								</el-row>
							</div>
							...
							<div  style="margin-top:30px">
								<el-row>
									<el-col :span="20" :offset="2">
										<el-button style="width:100%" @click="regist" type="success">登陆</el-button>
									</el-col>
								</el-row>
							</div>
                            <div  class="text-tip">
